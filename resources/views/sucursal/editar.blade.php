            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="card-body text-center">
                        Formulario para actualizar información de sucursal
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                ...
                <div class="container">
                    ...
                    <div class="col-sm-8 offset-sm-2">
                        <form action="" method="">
                            ...
                            <div class="mb-3">
                                <label for="nameProduct" class="form-label">ID Sucursal</label>
                            ...
                            <div class="mb-3">
                                <label for="quantityProduct" class="form-label">Email</label>
                                <input type="number" class="form-control" id="quantityProduct">
                            </div>
                            <br>
                            <div class="container-fluid">
